...
public class Notes
{
    public static void createArrayOfEvens()
    {
         ...
         *      The type can be a primitive (e.g., int) or a class (e.g., Turtle).
         *      
    ...
    public static void createArrayOfOdds()
    {
        ...
        /*
         * Limitiations of Enhanced For Loops
         * 
         *  The local variable (e.g., element) contains a copy of the value of the element in the array.
    ...
    public static void createArrayOfCalendars()
    {
         ...
         *      references to calendars), but we can call mutator methods which modify the properties
         *      of the referenced objects (e.g., day of the month).
         */
        for(GregorianCalendar calendar : calendars)
        {
